...
class DBWNode(object):
    def __init__(self):
        ...
        self.max_velocity = 0
         ...
         # PID
        throttle_Kp = 0.4 #0.3, 0.2
        throttle_Ki = 0.002 #0.003, 0.001
        throttle_Kd = 3.0 #4.0, 2.0, 1.0
        ...
        self.controller = Controller(vehicle_mass, brake_deadband, wheel_radius, decel_limit, wheel_base, steer_ratio, max_lat_accel, max_steer_angle, throttle_Kp, throttle_Ki, throttle_Kd)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            """
            proposed_linear_vel = self.twist_cmd.twist.linear
            proposed_angular_vel = self.twist_cmd.twist.angular
            current_vel = self.current_velocity.twist.linear
            """
